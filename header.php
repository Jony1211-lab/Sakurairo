...
<head>
    ...
    <?php $fonts_local = get_template_directory_uri() . '/fonts/fonts.css'; ?>
    <link rel="preload" href="<?php echo esc_url($fonts_local); ?>" as="style">
    <link rel="stylesheet" href="<?php echo esc_url($fonts_local); ?>" media="all">
